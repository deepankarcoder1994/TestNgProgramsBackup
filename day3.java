...
public class day3 {
	...
	//Before Suite => Before Suite will execute before any other Test Case defined in testng.xml
	@BeforeSuite
	...
	public void beforeevery() {
		System.out.println("I will execute before every test method in day3 class only");
	}
	...
	//Scope of this annotation only belongs to current class where it is defined
		...
		public void afterevery() {
			System.out.println("I will execute after every test method in day3 class only");
		}
